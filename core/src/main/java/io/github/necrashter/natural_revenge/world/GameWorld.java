...
//        modelBatch = new ModelBatch(vert, frag);
    ...
    public void addedToScreen() {
        // Initialize CheatManager with this world
        CheatManager.getInstance().setGameWorld(this);
    }
...
//        viewport.update(width, height, true);
    ...
    public void buildHudText(StringBuilder stringBuilder) {
        ...
        String cheatStatus = CheatManager.getInstance().getActiveCheatsSummary();
        if (!cheatStatus.isEmpty()) {
            stringBuilder.append(cheatStatus).append('\n');
        }
    }
